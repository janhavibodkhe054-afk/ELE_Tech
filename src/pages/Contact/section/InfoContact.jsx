...
const Contact = () => {
  return (
    <div className="bg-gray-50 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-3 bg-white border border-gray-200 shadow-2xl rounded-xl overflow-hidden">
          ...
          <div className="lg:col-span-2 p-6 sm:p-10 animate-slideLeft">
            ...
            <form className="space-y-6">
              <input type="text" placeholder="Your Name" className="w-full border border-gray-300 rounded-md px-4 py-3 focus:border-blue-600 focus:outline-none" />

              <div className="grid md:grid-cols-2 gap-6">
                <input type="email" placeholder="Your Email Address" className="w-full border border-gray-300 rounded-md px-4 py-3 focus:border-blue-600 focus:outline-none" />
                <input type="text" placeholder="Contact Number" className="w-full border border-gray-300 rounded-md px-4 py-3 focus:border-blue-600 focus:outline-none" />
              </div>

              <input type="text" placeholder="Subject" className="w-full border border-gray-300 rounded-md px-4 py-3 focus:border-blue-600 focus:outline-none" />

              <textarea rows="5" placeholder="Type Message" className="w-full border border-gray-300 rounded-md px-4 py-3 focus:border-blue-600 focus:outline-none"></textarea>
      ...
      {/* ================= MAP SECTION (BOTTOM) ================= */}
      <section className="w-full h-[320px] sm:h-[380px] lg:h-[420px]">
        <iframe
